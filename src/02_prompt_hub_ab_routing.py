...
PROMPT_V1_NAME = "day22-vinai-prompt-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "day22-vinai-prompt-v2"   # ví dụ: "nguyen-rag-v2"
...
SYSTEM_V1 = """Bạn là trợ lý AI hữu ích. Hãy trả lời câu hỏi dựa vào context dưới đây.
...
Hãy trả lời ngắn gọn (2-4 câu). Nếu không tìm thấy thông tin trong context, hãy trả lời là "Không tìm thấy thông tin trong context"."""
...
SYSTEM_V2 = """Bạn là chuyên gia AI. Hãy trả lời câu hỏi dựa vào context dưới đây.
...
Hãy trả lời rõ ràng và có tổ chức (3-5 câu). Nếu không tìm thấy thông tin trong context, hãy trả lời là "Không tìm thấy thông tin trong context".

Output JSON:
```json
{{
  "answer": "Trả lời của bạn",
